      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-12 bg-gradient-to-br from-primary to-secondary rounded-3xl flex items-center justify-center shadow-elevation-2">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-on-surface headline-large">
          ...
          {contents.map((content, index) => (
            ...
            >
              <Card className={cn(
                ...
                hoveredCard === content.id && "transform hover:-translate-y-1"
              )}>
                <CardContent className="p-0">
                  ...
                  <AnimatePresence mode="wait">
                    {expandedCard !== content.id ? (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-outline-variant">
                          ...
                          <ChevronRight className={cn(
                            ...
                            hoveredCard === content.id && "transform translate-x-1"
                          )} />
                        </div>
                      </motion.div>
                    ) : (
                      ...
                      >
                        {/* Enhanced Header */}
                        <div className="bg-gradient-to-br from-primary/10 via-secondary/5 to-tertiary/10 rounded-3xl p-6 mb-6 relative overflow-hidden">
                          ...
                          <div className="relative z-10">
                            <div className="flex items-start justify-between mb-4">
                              <div className="flex-1">
                                ...
                                <h2 className="text-2xl font-bold text-on-surface headline-medium mb-2">
                                  {content.title}
                                </h2>
                              ...
                              <div className="w-16 h-16 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-3xl flex items-center justify-center ml-6">
                        ...
                        <div className="grid grid-cols-4 gap-4 mb-6">
                          ...
                          <div className="bg-surface-container rounded-2xl p-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="text-sm font-medium text-on-surface">Level</p>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            ...
                            className="px-6 py-3 bg-gradient-to-r from-primary to-secondary text-on-primary rounded-2xl font-medium shadow-elevation-2 hover:shadow-elevation-3 transition-all duration-200 flex items-center gap-2"
                          >
